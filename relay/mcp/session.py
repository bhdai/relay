...
``MCPSessions`` maintains persistent connections for stateful MCP
servers that need their session kept alive between tool invocations
(e.g. browser-control or database servers).
"""
